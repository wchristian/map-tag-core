...
gps.teleport_to_position = function(player_index, pos, surface)
    ...
    if teleport_entity.teleport(pos, surface) then
        for i = 1, 5, 1 do
            ...
            surface.create_entity {
                name = "electric-beam",
                position = pos,
                target_position = {pos.x + offx, pos.y + 1},
                source_position = {pos.x + offx, pos.y - 2 + offy},
            ...
            surface.create_entity {
                name = "electric-beam",
                position = oldpos,
                target_position = {oldpos.x + offx, oldpos.y + 1},
                source_position = {oldpos.x + offx, oldpos.y - 2 + offy},
                duration = math.random(10, 30)
            }
        end
        return true
...
gps.teleport_to_tag = function(player_index, tag)
    ...
    if gps.teleport_to_position(player_index, pos, tag.surface) then
